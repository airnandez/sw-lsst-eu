...
In this document you will find information on a service designed so that you can use a binary distribution of the `LSST science pipelines <https://pipelines.lsst.io>`_ on your p ersonal computer without actually installing the software.
